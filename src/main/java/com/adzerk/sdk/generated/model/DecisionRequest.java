...
public class DecisionRequest implements Serializable {
   ...
   * @return the DecisionRequest instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(placements, user, keywords, url, referrer, ip, blockedCreatives, isMobile, includePricingData, notrack, enableBotFiltering, enableUserDBIP, consent, deviceID, parallel, intendedLatitude, intendedLongitude, radius, includeMatchedPoints, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DecisionRequest>() {
           ...
           public DecisionRequest read(JsonReader in) throws IOException {
             ...
             DecisionRequest instance = thisAdapter.fromJsonTree(jsonObj);
