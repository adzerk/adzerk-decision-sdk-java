...
public class CandidateRetrieval implements Serializable {
   ...
   * @return the CandidateRetrieval instance itself
   */
  public CandidateRetrieval putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.candidatesFoundCount, candidateRetrieval.candidatesFoundCount)&&
        Objects.equals(this.additionalProperties, candidateRetrieval.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(candidatesFoundCount, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CandidateRetrieval>() {
           ...
           public CandidateRetrieval read(JsonReader in) throws IOException {
             ...
             CandidateRetrieval instance = thisAdapter.fromJsonTree(jsonObj);
