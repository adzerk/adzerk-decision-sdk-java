...
public class Placement implements Serializable {
   ...
   * @return the Placement instance itself
   */
  public Placement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.divName, placement.divName) &&
        ...
        Objects.equals(this.additionalProperties, placement.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(divName, networkId, siteId, adTypes, zoneIds, campaignId, flightId, adId, clickUrl, properties, eventIds, overrides, contentKeys, count, proportionality, ecpmPartition, ecpmPartitions, eventMultiplier, skipSelection, adQuery, floorPrice, floorCpc, skipFilters, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Placement>() {
           ...
           public Placement read(JsonReader in) throws IOException {
             ...
             Placement instance = thisAdapter.fromJsonTree(jsonObj);
