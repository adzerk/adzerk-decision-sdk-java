...
import com.adzerk.sdk.generated.auth.Authentication;
import com.adzerk.sdk.generated.auth.HttpBasicAuth;
import com.adzerk.sdk.generated.auth.HttpBearerAuth;
import com.adzerk.sdk.generated.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://e-23.adzerk.net";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "{protocol}://e-{networkId}.adzerk.net",
      ...
      new HashMap<String, ServerVariable>() {{
        ...
        put("networkId", new ServerVariable(
          "Your Adzerk Network Id",
          "23",
          new HashSet<String>(
          )
        ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://e-23.adzerk.net
